...
const sendMessageMutationOptions = mutationOptions({
  ...
  mutationFn: (options: {
    data: Parameters<typeof app.client.message.post>["0"];
    password: string;
  }) =>
    app.client.message.post(options.data, {
      headers: {
  ...
  return (
    <div>
      <form
        ...
        className="max-w-md space-y-4 rounded-lg bg-zinc-900 p-6 text-zinc-100 shadow-lg shadow-zinc-950/50"
      >
